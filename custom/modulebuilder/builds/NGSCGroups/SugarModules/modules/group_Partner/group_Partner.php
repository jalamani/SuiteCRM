...
class group_Partner extends Company
{
    public $new_schema = true;
    public $module_dir = 'group_Partner';
    public $object_name = 'group_Partner';
    public $table_name = 'group_partner';

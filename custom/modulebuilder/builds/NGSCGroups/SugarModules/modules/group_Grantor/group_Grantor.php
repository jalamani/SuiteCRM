...
class group_Grantor extends Company
{
    public $new_schema = true;
    public $module_dir = 'group_Grantor';
    public $object_name = 'group_Grantor';
    public $table_name = 'group_grantor';
    ...
    public $awarddate;
    public $reportstatus;
    public $reportcompletedate;
    public $nextyeardeadline;

...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_EMERGENCYFIRST_NAME' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.emergencyfirst_name_c.value) <= 0}
{assign var="value" value=$fields.emergencyfirst_name_c.default_value }
{else}
{assign var="value" value=$fields.emergencyfirst_name_c.value }
{/if}  
<input type='text' name='{$fields.emergencyfirst_name_c.name}' 
id='{$fields.emergencyfirst_name_c.name}' size='30' 
maxlength='100' 
value='{$value}' title=''      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_EMERGENCYLAST_NAME' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.emergencylast_name_c.value) <= 0}
{assign var="value" value=$fields.emergencylast_name_c.default_value }
{else}
{assign var="value" value=$fields.emergencylast_name_c.value }
{/if}  
<input type='text' name='{$fields.emergencylast_name_c.name}' 
id='{$fields.emergencylast_name_c.name}' size='30' 
maxlength='100' 
value='{$value}' title=''      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_EMERGENCY_EMAIL' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.emergency_email_c.value) <= 0}
{assign var="value" value=$fields.emergency_email_c.default_value }
{else}
{assign var="value" value=$fields.emergency_email_c.value }
{/if}  
<input type='text' name='{$fields.emergency_email_c.name}' 
id='{$fields.emergency_email_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_EMERGENCY_PHONE' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.emergency_phone_c.value) <= 0}
{assign var="value" value=$fields.emergency_phone_c.default_value }
{else}
{assign var="value" value=$fields.emergency_phone_c.value }
{/if}  
<input type='text' name='{$fields.emergency_phone_c.name}' id='{$fields.emergency_phone_c.name}' size='30' maxlength='255' value='{$value}' title='' tabindex='0'	  class="phone" >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_EMERGENCY_RELATIONSHIP' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.emergency_relationship_c.name}" 
id="{$fields.emergency_relationship_c.name}" 
title=''       
>
{if isset($fields.emergency_relationship_c.value) && $fields.emergency_relationship_c.value != ''}
{html_options options=$fields.emergency_relationship_c.options selected=$fields.emergency_relationship_c.value}
{else}
{html_options options=$fields.emergency_relationship_c.options selected=$fields.emergency_relationship_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.emergency_relationship_c.options }
{capture name="field_val"}{$fields.emergency_relationship_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.emergency_relationship_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.emergency_relationship_c.name}" 
id="{$fields.emergency_relationship_c.name}" 
title=''          
>
{if isset($fields.emergency_relationship_c.value) && $fields.emergency_relationship_c.value != ''}
...
<input
id="{$fields.emergency_relationship_c.name}-input"
name="{$fields.emergency_relationship_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.emergency_relationship_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.emergency_relationship_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.emergency_relationship_c.name}-input', '{$fields.emergency_relationship_c.name}');sync_{$fields.emergency_relationship_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.emergency_relationship_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.emergency_relationship_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.emergency_relationship_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.emergency_relationship_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.emergency_relationship_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.emergency_relationship_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.emergency_relationship_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_DRUGS_PROBLEM' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if strval($fields.drugs_problem_c.value) == "1" || strval($fields.drugs_problem_c.value) == "yes" || strval($fields.drugs_problem_c.value) == "on"} 
{assign var="checked" value='checked="checked"'}
{else}
{assign var="checked" value=""}
{/if}
<input type="hidden" name="{$fields.drugs_problem_c.name}" value="0"> 
<input type="checkbox" id="{$fields.drugs_problem_c.name}" 
name="{$fields.drugs_problem_c.name}" 
value="1" title='' tabindex="0" {$checked} >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_FELON' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if strval($fields.felon_c.value) == "1" || strval($fields.felon_c.value) == "yes" || strval($fields.felon_c.value) == "on"} 
{assign var="checked" value='checked="checked"'}
{else}
{assign var="checked" value=""}
{/if}
<input type="hidden" name="{$fields.felon_c.name}" value="0"> 
<input type="checkbox" id="{$fields.felon_c.name}" 
name="{$fields.felon_c.name}" 
value="1" title='' tabindex="0" {$checked} >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_INCARCERATED' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if strval($fields.incarcerated_c.value) == "1" || strval($fields.incarcerated_c.value) == "yes" || strval($fields.incarcerated_c.value) == "on"} 
{assign var="checked" value='checked="checked"'}
{else}
{assign var="checked" value=""}
{/if}
<input type="hidden" name="{$fields.incarcerated_c.name}" value="0"> 
<input type="checkbox" id="{$fields.incarcerated_c.name}" 
name="{$fields.incarcerated_c.name}" 
value="1" title='' tabindex="0" {$checked} >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_MENTALLYILL' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if strval($fields.mentallyill_c.value) == "1" || strval($fields.mentallyill_c.value) == "yes" || strval($fields.mentallyill_c.value) == "on"} 
{assign var="checked" value='checked="checked"'}
{else}
{assign var="checked" value=""}
{/if}
<input type="hidden" name="{$fields.mentallyill_c.name}" value="0"> 
<input type="checkbox" id="{$fields.mentallyill_c.name}" 
name="{$fields.mentallyill_c.name}" 
value="1" title='' tabindex="0" {$checked} >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_MENTAL_ILLNESS' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.mental_illness_c.value) <= 0}
{assign var="value" value=$fields.mental_illness_c.default_value }
{else}
{assign var="value" value=$fields.mental_illness_c.value }
{/if}  
<input type='text' name='{$fields.mental_illness_c.name}' 
id='{$fields.mental_illness_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_MARRITAL' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.marrital_c.name}" 
id="{$fields.marrital_c.name}" 
title=''       
>
{if isset($fields.marrital_c.value) && $fields.marrital_c.value != ''}
{html_options options=$fields.marrital_c.options selected=$fields.marrital_c.value}
{else}
{html_options options=$fields.marrital_c.options selected=$fields.marrital_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.marrital_c.options }
{capture name="field_val"}{$fields.marrital_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.marrital_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.marrital_c.name}" 
id="{$fields.marrital_c.name}" 
title=''          
>
{if isset($fields.marrital_c.value) && $fields.marrital_c.value != ''}
...
<input
id="{$fields.marrital_c.name}-input"
name="{$fields.marrital_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.marrital_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.marrital_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.marrital_c.name}-input', '{$fields.marrital_c.name}');sync_{$fields.marrital_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.marrital_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.marrital_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.marrital_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.marrital_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.marrital_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.marrital_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.marrital_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_BGRND_DESC' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_FAILEDBACK' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if strval($fields.failedback_c.value) == "1" || strval($fields.failedback_c.value) == "yes" || strval($fields.failedback_c.value) == "on"} 
{assign var="checked" value='checked="checked"'}
{else}
{assign var="checked" value=""}
{/if}
<input type="hidden" name="{$fields.failedback_c.name}" value="0"> 
<input type="checkbox" id="{$fields.failedback_c.name}" 
name="{$fields.failedback_c.name}" 
value="1" title='' tabindex="0" {$checked} >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_PRESENTLY_EMPLOYED' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if strval($fields.presently_employed_c.value) == "1" || strval($fields.presently_employed_c.value) == "yes" || strval($fields.presently_employed_c.value) == "on"} 
{assign var="checked" value='checked="checked"'}
{else}
{assign var="checked" value=""}
{/if}
<input type="hidden" name="{$fields.presently_employed_c.name}" value="0"> 
<input type="checkbox" id="{$fields.presently_employed_c.name}" 
name="{$fields.presently_employed_c.name}" 
value="1" title='' tabindex="0" {$checked} >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_REFERRAL' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.referral_c.value) <= 0}
{assign var="value" value=$fields.referral_c.default_value }
{else}
{assign var="value" value=$fields.referral_c.value }
{/if}  
<input type='text' name='{$fields.referral_c.name}' 
id='{$fields.referral_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_REFERRALTYPE' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.referraltype_c.name}" 
id="{$fields.referraltype_c.name}" 
title=''       
>
{if isset($fields.referraltype_c.value) && $fields.referraltype_c.value != ''}
{html_options options=$fields.referraltype_c.options selected=$fields.referraltype_c.value}
{else}
{html_options options=$fields.referraltype_c.options selected=$fields.referraltype_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.referraltype_c.options }
{capture name="field_val"}{$fields.referraltype_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.referraltype_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.referraltype_c.name}" 
id="{$fields.referraltype_c.name}" 
title=''          
>
{if isset($fields.referraltype_c.value) && $fields.referraltype_c.value != ''}
...
<input
id="{$fields.referraltype_c.name}-input"
name="{$fields.referraltype_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.referraltype_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.referraltype_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.referraltype_c.name}-input', '{$fields.referraltype_c.name}');sync_{$fields.referraltype_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.referraltype_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.referraltype_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.referraltype_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.referraltype_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.referraltype_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.referraltype_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.referraltype_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_RESUME' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
<span class="sugar_field" id="{$fields.resume_c.name}"></span>
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_RESUMEAV' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if strval($fields.resumeav_c.value) == "1" || strval($fields.resumeav_c.value) == "yes" || strval($fields.resumeav_c.value) == "on"} 
{assign var="checked" value='checked="checked"'}
{else}
{assign var="checked" value=""}
{/if}
<input type="hidden" name="{$fields.resumeav_c.name}" value="0"> 
<input type="checkbox" id="{$fields.resumeav_c.name}" 
name="{$fields.resumeav_c.name}" 
value="1" title='' tabindex="0" {$checked} >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_MONTHLY_INCOME' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.monthly_income_c.value) <= 0}
{assign var="value" value=$fields.monthly_income_c.default_value }
{else}
{assign var="value" value=$fields.monthly_income_c.value }
{/if}  
<input type='text' name='{$fields.monthly_income_c.name}' 
id='{$fields.monthly_income_c.name}' size='30' maxlength='26' value='{sugar_number_format var=$value}' title='' tabindex='0'
>
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_SHELTER_NAME' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.shelter_name_c.value) <= 0}
{assign var="value" value=$fields.shelter_name_c.default_value }
{else}
{assign var="value" value=$fields.shelter_name_c.value }
{/if}  
<input type='text' name='{$fields.shelter_name_c.name}' 
id='{$fields.shelter_name_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_OTHER_ASSIST' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.other_assist_c.value) <= 0}
{assign var="value" value=$fields.other_assist_c.default_value }
{else}
{assign var="value" value=$fields.other_assist_c.value }
{/if}  
<input type='text' name='{$fields.other_assist_c.name}' 
id='{$fields.other_assist_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_PASSPORT' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.passport_c.value) <= 0}
{assign var="value" value=$fields.passport_c.default_value }
{else}
{assign var="value" value=$fields.passport_c.value }
{/if}  
<input type='text' name='{$fields.passport_c.name}' 
id='{$fields.passport_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_PASSPORT_IMAGE' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
<script type="text/javascript" src='include/SugarFields/Fields/Image/SugarFieldFile.js?v=RedUUPqXwqtNB1eEqN3gEg'></script>
{if !empty($fields.passport_image_c.value) }
{assign var=showRemove value=true}
{else}
{assign var=showRemove value=false}
{/if}
{assign var=noChange value=false}
<input type="hidden" name="deleteAttachment" value="0">
<input type="hidden" name="{$fields.passport_image_c.name}" id="{$fields.passport_image_c.name}" value="{$fields.passport_image_c.value}">
<input type="hidden" name="{$fields.passport_image_c.name}_record_id" id="{$fields.passport_image_c.name}_record_id" value="{$fields.id.value}">
<span id="{$fields.passport_image_c.name}_old" style="display:{if !$showRemove}none;{/if}">
<a href="index.php?entryPoint=download&id={$fields.id.value}_{$fields.passport_image_c.name}&type={$module}&time={$fields.date_modified.value}" class="tabDetailViewDFLink">{$fields.passport_image_c.value}</a>
{if !$noChange}
<input type='button' class='button' id='remove_button' value='{$APP.LBL_REMOVE}' onclick='SUGAR.field.file.deleteAttachment("{$fields.passport_image_c.name}","",this);'>
{/if}
</span>
{if !$noChange}
<span id="{$fields.passport_image_c.name}_new" style="display:{if $showRemove}none;{/if}">
<input type="hidden" name="{$fields.passport_image_c.name}_escaped">
<input id="{$fields.passport_image_c.name}_file" name="{$fields.passport_image_c.name}_file"
type="file" title='' size="30"
maxlength='255'
>
{else}
...
{/if}
<script type="text/javascript">
$( "#{$fields.passport_image_c.name}_file{literal} " ).change(function() {
        $("#{/literal}{$fields.passport_image_c.name}{literal}").val($("#{/literal}{$fields.passport_image_c.name}_file{literal}").val());
});{/literal}
        </script>
</span>
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_SSN' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.ssn_c.value) <= 0}
{assign var="value" value=$fields.ssn_c.default_value }
{else}
{assign var="value" value=$fields.ssn_c.value }
{/if}  
<input type='text' name='{$fields.ssn_c.name}' 
id='{$fields.ssn_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_SSNDOC' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
<script type="text/javascript" src='include/SugarFields/Fields/Image/SugarFieldFile.js?v=RedUUPqXwqtNB1eEqN3gEg'></script>
{if !empty($fields.ssndoc_c.value) }
{assign var=showRemove value=true}
{else}
{assign var=showRemove value=false}
{/if}
{assign var=noChange value=false}
<input type="hidden" name="deleteAttachment" value="0">
<input type="hidden" name="{$fields.ssndoc_c.name}" id="{$fields.ssndoc_c.name}" value="{$fields.ssndoc_c.value}">
<input type="hidden" name="{$fields.ssndoc_c.name}_record_id" id="{$fields.ssndoc_c.name}_record_id" value="{$fields.id.value}">
<span id="{$fields.ssndoc_c.name}_old" style="display:{if !$showRemove}none;{/if}">
<a href="index.php?entryPoint=download&id={$fields.id.value}_{$fields.ssndoc_c.name}&type={$module}&time={$fields.date_modified.value}" class="tabDetailViewDFLink">{$fields.ssndoc_c.value}</a>
{if !$noChange}
<input type='button' class='button' id='remove_button' value='{$APP.LBL_REMOVE}' onclick='SUGAR.field.file.deleteAttachment("{$fields.ssndoc_c.name}","",this);'>
{/if}
</span>
{if !$noChange}
<span id="{$fields.ssndoc_c.name}_new" style="display:{if $showRemove}none;{/if}">
<input type="hidden" name="{$fields.ssndoc_c.name}_escaped">
<input id="{$fields.ssndoc_c.name}_file" name="{$fields.ssndoc_c.name}_file"
type="file" title='' size="30"
maxlength='255'
>
{else}
...
{/if}
<script type="text/javascript">
$( "#{$fields.ssndoc_c.name}_file{literal} " ).change(function() {
        $("#{/literal}{$fields.ssndoc_c.name}{literal}").val($("#{/literal}{$fields.ssndoc_c.name}_file{literal}").val());
});{/literal}
        </script>
</span>
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_HOURS' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
id='{$fields.hours_c.name}' size='30' maxlength='255' value='{sugar_number_format precision=0 var=$value}' title='' tabindex='0'    >
</div>

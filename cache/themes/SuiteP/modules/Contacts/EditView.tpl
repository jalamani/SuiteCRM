...
{/if}  
<input type='text' name='{$fields.ethnicity_c.name}' 
id='{$fields.ethnicity_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
addToValidate('EditView', 'age_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_AGE' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'ethnicity_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_ETHNICITY' module='Contacts' for_js=true}{literal}' );

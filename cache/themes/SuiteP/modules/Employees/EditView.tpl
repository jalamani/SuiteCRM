...
addToValidate('EditView', 'first_name', 'name', true,'{/literal}{sugar_translate label='LBL_FIRST_NAME' module='Employees' for_js=true}{literal}' );
...
addToValidate('EditView', 'availability_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_AVAILABILITY' module='Employees' for_js=true}{literal}' );
addToValidate('EditView', 'firstday_c', 'date', true,'{/literal}{sugar_translate label='LBL_FIRSTDAY' module='Employees' for_js=true}{literal}' );
